...
/**
 * The platform type that is bridged
 */
...
export interface BaseEvent {
  ...
  /**
   * The instance that initiated this event.
   */
...
export type ChatLike = MinecraftGuildChat | MinecraftPrivateChat | DiscordChat //| BaseChat

// eslint-disable-next-line @typescript-eslint/naming-convention
type NeverClass<Origin, NeverType> = Origin extends NeverType ? never : Origin
export interface BaseChat extends InformEvent {
  readonly instance: NeverClass<Instance, MinecraftInstance | DiscordInstance>
...
export interface MinecraftChat extends BaseChat, MinecraftRawMessage {
  ...
  readonly platform: Platform.Minecraft
...
export interface DiscordChat extends BaseChat {
  readonly instance: DiscordInstance
...
export interface BroadcastEvent extends InformEvent {
   ...
   */
  readonly user: AnonymousUser | undefined
  /**
...
export type CommandLike = DiscordCommandEvent | MinecraftCommandEvent | GenericCommandEvent
