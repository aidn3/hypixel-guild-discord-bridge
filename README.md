...
| bypass-hypixel-url | Bypass Hypixel restriction on hyperlinks                                                | Quality of Life | Requires the installation of [BridgeChatTrigger](https://www.chattriggers.com/modules/v/BridgeChatTrigger) on client side.            |
